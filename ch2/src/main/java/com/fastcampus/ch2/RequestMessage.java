...
public class RequestMessage {
	...
	public void main(HttpServletRequest request) throws Exception {
		...
		// 1. request line
		String requestLine = request.getMethod()+"1";       // GET 또는 POST
		requestLine += " " + request.getRequestURI()+"2";   // /ch2/requestMessage
		
		String queryString = request.getQueryString()+"3";  // year=2021&month=10&day=1
		requestLine += queryString == null ? "" : "?"+queryString;  
		requestLine += " " + request.getProtocol()+"4";     // HTTP/1.1
